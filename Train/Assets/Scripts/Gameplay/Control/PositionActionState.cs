...
{
    public class PositionActionState<T>
    {
        ...
        public T[] AffectedObjects{ get; private set; }

        public PositionActionState(Vector2 position, bool isHovering, bool isMainActionPressedOnObject, bool isMainActionReleasedOnObject, bool isMainActionHeldDown, T[] affectedObjects)
        {
